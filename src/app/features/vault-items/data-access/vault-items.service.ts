...
function toVaultItem(a: ApiVaultItem): VaultItem {
  ...
  return {
    ...
    children_done_count:       a.children_done_count,
    children_active_count:     a.children_active_count,
    children_inbox_count:      a.children_inbox_count,
    children_blocked_count:    a.children_blocked_count,
    children_done_7d:          a.children_done_7d,
    children_done_30d:         a.children_done_30d,
    last_child_completed_at:   a.last_child_completed_at,
