...
export const componentRegistry: readonly LabRegistryEntry[] = [
  ...
  { id: 'ui-tally-strip',          name: 'Tally Strip',           group: 'cards',           selector: 'app-ui-tally-strip',    description: 'One tick per unit, grouped and capped, mixed out of the project tint into alarm. Takes a number, not a date.' },
