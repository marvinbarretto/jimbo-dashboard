...
* **grooming:** show queue flow, so a growing queue stops reading as a draining one ([c7f1820](https://github.com/marvinbarretto/jimbo-dashboard/commit/c7f18200a7e0f543908c96367518132159ada7d3))
...
* **vault-item:** a commission delivery reads "delivered", not "ran" ([f20a00f](https://github.com/marvinbarretto/jimbo-dashboard/commit/f20a00f2aae5586f275ac5795406704ccc92d0cf))
...
* **review-card:** show what the change looks like ([fdd560b](https://github.com/marvinbarretto/jimbo-dashboard/commit/fdd560b5f89fa46cface67d0fd57e684f0263528))
...
* **review-card:** show the EPIC's why, or name that there isn't one ([92d1f81](https://github.com/marvinbarretto/jimbo-dashboard/commit/92d1f818f8265e22cfb9a4ad4e6e5d9eba980630)), closes [#2812](https://github.com/marvinbarretto/jimbo-dashboard/issues/2812)
...
* **review-card:** lead with what this belongs to, and what it is for ([5432109](https://github.com/marvinbarretto/jimbo-dashboard/commit/54321095de2fc70d40ac019b5ea3da0a7c2417b8))
...
* **mobile:** add the NOW card and attention row to the phone home ([9137d9b](https://github.com/marvinbarretto/jimbo-dashboard/commit/9137d9b52f2839eed4de2da3823648647f877699))
