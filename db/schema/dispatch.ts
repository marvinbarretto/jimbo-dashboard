...
export const dispatchQueue = pgTable('dispatch_queue', {
  ...
  // Skill identifier — slash-path under hub/skills/ (e.g. 'vault-grooming/analyse').
  // Soft reference into the filesystem skill registry; runners read SKILL.md by path.
  skill: text('skill'),
